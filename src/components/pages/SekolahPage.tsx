    ...
    <div className="flex flex-col gap-5">
      ...
      <SectionCard title="Konfigurasi Akademik">
        <div className="grid grid-cols-2 gap-4">
          ...
          <Input label={<span className="flex items-center gap-1">Tanggal TTD Transkrip &amp; Ijazah <InfoTooltip text="Tanggal yang muncul di baris tanda tangan Kepala Sekolah pada dokumen Transkrip Nilai dan Ijazah. Kosongkan untuk memakai Tanggal Penetapan Lulus." position="bottom" /></span>} type="date" value={form.tgl_ttd_kepsek || ''} onChange={e => set('tgl_ttd_kepsek', e.target.value)} />
